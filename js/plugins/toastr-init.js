!(function(a) {
    ...
    $("#ts-success").on("click", function() {
        toastr.success("از طوفان قلعه لذت ببرید!", "معجزه مکس می گوید");
    });

    // Success Type
    $("#ts-info").on("click", function() {
        toastr.info("ما مجموعه Kapua را در دسترس داریم.", "تفرجگاه خلیج لاک پشت");
    });

    // Success Type
    $("#ts-warning").on("click", function() {
        toastr.warning(
            "نام من اینیگو مونتویا است.شما پدرم را کشتید ، آماده شوید تا بمیرید!"
        );
    });
    ...
    $("#ts-error").on("click", function() {
        toastr.error(
            "من فکر نمی کنم که این کلمه به معنای آنچه شما فکر می کنید به معنای آن است.",
            "غیرقابل تصور!"
        );
    });
    ...
    $("#pos-top-left").on("click", function() {
        toastr.info(
            "من فکر نمی کنم که این کلمه به معنای آنچه شما فکر می کنید معنی دارد.",
            "بالا سمت چپ!", { positionClass: "TOAST TOAST-TOP چپ", containerId: "با نان تست بالا" }
        );
    });
    ...
    $("#pos-top-center").on("click", function() {
        toastr.info(
            "من فکر نمی کنم که این کلمه به معنای آنچه شما فکر می کنید معنی دارد.",
            "مرکز عالی!", {
                positionClass: "تست تاپ تاپ",
                containerId: "در مرکز نان تست",
            }
        );
    });
    ...
    $("#pos-top-full").on("click", function() {
        toastr.info(
            "من فکر نمی کنم که این کلمه به معنای آنچه شما فکر می کنید معنی آن است.",
            "عرض کامل بالا!", {
    ...
    $("#text-notification").on("click", function() {
        toastr.info("از طوفان قلعه لذت ببرید!", "معجزه مکس می گوید");
    });

    // Close Button
    $("#close-button").on("click", function() {
        toastr.success("از طوفان قلعه لذت ببرید!", "با دکمه بستن", {
            closeButton: true,
        });
    });
    ...
    $("#progress-bar").on("click", function() {
        toastr.warning("از طوفان قلعه لذت ببرید!", "نوار پیشرفت", {
            progressBar: true,
        });
    });
    ...
    $("#slide-toast").on("click", function() {
        toastr.success(
            "این یک متن تست می باشد",
            "به پایین بکشید / اسلاید کنید!", { showMethod: "slideDown", hideMethod: "slideUp", timeOut: 2000 }
        );
    });
    ...
    $("#fade-toast").on("click", function() {
        toastr.success(
            "این یک متن تست می باشد",
            "به پایین بکشید / اسلاید کنید!", { showMethod: "fadeIn", hideMethod: "fadeOut", timeOut: 2000 }
        );
    });
})(
